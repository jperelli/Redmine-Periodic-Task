...
- refs #138 support for RedmineUP Tags plugin: tags configured on a periodic task (with autocomplete from existing tags) are added to each generated issue **requires migration** (@jperelli)
